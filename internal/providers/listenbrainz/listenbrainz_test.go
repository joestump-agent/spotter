...
// --- Listen submission (REQ-PROV-049) ---
...
// Governing: SPEC music-provider-integration REQ-PROV-047, REQ-PROV-049 — a
...
// Governing: SPEC music-provider-integration REQ-PROV-049 — listens missing a
...
// Governing: SPEC music-provider-integration REQ-PROV-049 — a rejected batch
...
func TestListenSubmitterInterface(t *testing.T) {
	// Governing: SPEC music-provider-integration REQ-PROV-049 — the provider
