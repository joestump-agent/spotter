...
func (_c *UserCreate) SetSpotifyAuthID(id int) *UserCreate {
	_c.mutation.SetSpotifyAuthID(id)
	return _c
}

// SetNillableSpotifyAuthID sets the "spotify_auth" edge to the SpotifyAuth entity by ID if the given value is not nil.
func (_c *UserCreate) SetNillableSpotifyAuthID(id *int) *UserCreate {
	if id != nil {
		_c = _c.SetSpotifyAuthID(*id)
	}
	return _c
}

// SetSpotifyAuth sets the "spotify_auth" edge to the SpotifyAuth entity.
func (_c *UserCreate) SetSpotifyAuth(v *SpotifyAuth) *UserCreate {
	return _c.SetSpotifyAuthID(v.ID)
}

// SetLastfmAuthID sets the "lastfm_auth" edge to the LastFMAuth entity by ID.
func (_c *UserCreate) SetLastfmAuthID(id int) *UserCreate {
	_c.mutation.SetLastfmAuthID(id)
	return _c
}

// SetNillableLastfmAuthID sets the "lastfm_auth" edge to the LastFMAuth entity by ID if the given value is not nil.
func (_c *UserCreate) SetNillableLastfmAuthID(id *int) *UserCreate {
	if id != nil {
		_c = _c.SetLastfmAuthID(*id)
	}
	return _c
}
...
func (_c *UserCreate) AddListens(v ...*Listen) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.SpotifyAuthIDs(); len(nodes) > 0 {
	...
	if nodes := _c.mutation.LastfmAuthIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
